  ...
  const handleReroll = async (e: React.MouseEvent) => {
    ...
    return (
      ...
      <div 
          ...
          className={`flex ${flexClass} items-center justify-center relative group transition-transform duration-300 gap-0.5`}
      ...
      >
        ...
        <div 
          ...
          className={`text-[10px] leading-tight text-center font-medium text-zinc-800 break-words px-1 z-20 ${isVertical ? 'w-full' : 'w-24'}`}
