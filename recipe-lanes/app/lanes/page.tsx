...
function RecipeLanesContent() {
  ...
  const { mergeSnapshot, setGraph, reset: resetRecipeStore, addMessage, clearMessages } = useRecipeStore.getState();
...
const handleVisualize = async () => {
  ...
  const handleAdjust = async () => {
      ...
      try {
          ...
          setGraph(res.graph);
          addMessage({ role: 'assistant', content: res.adjustment || 'Done! The recipe has been updated.' });
          setShowChat(true);
